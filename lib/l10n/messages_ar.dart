...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "detailsOnErrorCopied" : MessageLookupByLibrary.simpleMessage("نُسخت تفاصيل الخطأ الى الحافظة."),
    "detailsOnErrorDescription" : MessageLookupByLibrary.simpleMessage("حدث الخطأ الداخلي التالي. رجاء ضمن هذا عند طلب المساعدة."),
    "detailsOnErrorLabel" : MessageLookupByLibrary.simpleMessage("مساعدة"),
    ...
    "errorSignInTimeout" : MessageLookupByLibrary.simpleMessage("انتهت مهلة التصريح، أمتأكد من دعم خادمك لل API ؟"),
    "errorUnexpectedErrorOnAuthorization" : MessageLookupByLibrary.simpleMessage("حدث خطأ غير متوقع أثناء محاولة ."),
    ...
    "failedToLoadContent" : MessageLookupByLibrary.simpleMessage("حدث خطأ أثناء تحميل المحتوى."),
    ...
    "retryLabel" : MessageLookupByLibrary.simpleMessage("أعد المحاولة"),
